...
| [20260718-feature-historical-backfill](20260718-feature-historical-backfill.md) | collector | 2026-07-19 | One-shot `backfill` CLI for prior-day matches via `fetch_schedule`/`fetch_match_detail`, closing the Follow-up Work gap left by `20260711-feature-finished-match-backfill`. Implemented via 5-phase `/conduct` run (715 passed/1 skipped, smoke script 14/14). PR #5. |
